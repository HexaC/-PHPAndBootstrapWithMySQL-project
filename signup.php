...
<section class="container p-4">
    <div class="col-md-6">
        <h1 class="mt-4 mb-4 display-6">Sign up</h1>
        ...
        <form method="POST" novalidate="novalidate" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <?= field_errors('name') ?>
                <div id="emailHelp" class="form-text">It can be a nickname to!</div>
            </div>
            <div class="mb-3">
                ...
                <?= field_errors('email') ?>
                <div id="emailHelp" class="form-text">We'll never send you spam email.</div>
            </div>
            <div class="mb-3">
                <label for="password" class="form-label">Password</label>
                <input type="password" name="password" class="form-control" id="password">
                <?= field_errors('password') ?>
                <div id="emailHelp" class="form-text">We'll never ask for your password.</div>
            </div>
            <div class="mb-3">
                <label for="formFile" class="form-label">Profile image</label>
                <input class="form-control" type="file" name="image" id="formFile">
                <div id="emailHelp" class="form-text">Types: jpeg, jpg, png, gif & Max 2MB.</div>
            </div>
    </div>
    <button type="submit" name="submit" value="submit" class="btn btn-primary mt-2">Sign Up</button>
    <?= field_errors('submit') ?>
    </form>
